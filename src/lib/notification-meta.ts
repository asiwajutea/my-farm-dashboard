...
const META: Record<NotificationKind, Meta> = {
  ...
  cycle_started: { icon: Sprout, tone: "text-primary bg-primary/15", to: "/farm" },
  ...
  p2p_sent: { icon: ArrowUpRight, tone: "text-muted-foreground bg-muted", to: "/wallet" },
  transfer_to_farming: { icon: ArrowRightLeft, tone: "text-primary bg-primary/15", to: "/wallet" },
  ...
  affiliate_signup: { icon: Users, tone: "text-primary bg-primary/15", to: "/affiliate/downlines" },
  maintenance_due: { icon: CalendarClock, tone: "text-amber-400 bg-amber-400/15", to: "/affiliate" },
  maintenance_paid: { icon: CheckCircle2, tone: "text-emerald-400 bg-emerald-400/15", to: "/affiliate" },
  ...
  kyc_submitted: { icon: FileCheck, tone: "text-amber-400 bg-amber-400/15", to: "/verify" },
